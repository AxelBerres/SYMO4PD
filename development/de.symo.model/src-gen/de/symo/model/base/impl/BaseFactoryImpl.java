...
public class BaseFactoryImpl extends EFactoryImpl implements BaseFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case BasePackage.VALUE: return createValue();
			case BasePackage.APARAMETER_DEF: return createAParameterDef();
			default:
	 ...
	 * @generated
	 */
	public AParameterDef createAParameterDef() {
		AParameterDefImpl aParameterDef = new AParameterDefImpl();
