...
/**
 * This is the item provider adapter for a {@link model.OntologyLibrary} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OntologyLibraryItemProvider 
	 ...
	 * @generated
	 */
	public OntologyLibraryItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OntologyLibrary_Name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OntologyLibrary_Name_feature", "_UI_OntologyLibrary_type"),
				 ModelPackage.Literals.ONTOLOGY_LIBRARY__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns OntologyLibrary.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OntologyLibrary"));
	}
	...
	public String getText(Object object) {
		String label = ((OntologyLibrary)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_OntologyLibrary_type") :
			getString("_UI_OntologyLibrary_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OntologyLibrary.class)) {
