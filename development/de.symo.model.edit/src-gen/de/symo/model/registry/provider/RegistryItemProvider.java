...
/**
 * This is the item provider adapter for a {@link de.symo.model.registry.Registry} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RegistryItemProvider extends ANameItemItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((Registry)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Registry_type") :
			getString("_UI_Registry_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RegistryPackage.Literals.REGISTRY__CONSTANTS,
				 RegistryFactory.eINSTANCE.createConstant()));
